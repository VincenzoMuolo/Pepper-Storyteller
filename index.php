...
<html lang="it">
    ...
    <body onload="show_button();">       
        ...
        <div id="center-page" class="centerPage">
			...
			<div id="id-contact-us" class="writeStory" style="display:none;">
					...
					<h3>Compila il form</h3>
                      <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                      	<div class="form-box">    
                        	...
                        	<input type="text" name="email" class="form-control <?php echo (!empty($email_err)) ? 'is-invalid' : ''; ?>" value="<?php echo $email; ?>" required="required" autocomplete="email">
                          	<span class="invalid-feedback"><?php echo $email_err; ?></span>
                            <span class="message-text">Messaggio</span>
                            <textarea id="pepper-message" class="form-control" name='message' required="required"> </textarea>
